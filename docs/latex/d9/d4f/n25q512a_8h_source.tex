\hypertarget{n25q512a_8h_source}{}\doxysection{n25q512a.\+h}
\label{n25q512a_8h_source}\index{lib/Components/n25q512a/n25q512a.h@{lib/Components/n25q512a/n25q512a.h}}
\mbox{\hyperlink{n25q512a_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 }
\DoxyCodeLine{38 \textcolor{comment}{/* Define to prevent recursive inclusion -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/*/}}
\DoxyCodeLine{39 \textcolor{preprocessor}{\#ifndef \_\_N25Q512A\_H}}
\DoxyCodeLine{40 \textcolor{preprocessor}{\#define \_\_N25Q512A\_H}}
\DoxyCodeLine{41 }
...
\DoxyCodeLine{47 }
\DoxyCodeLine{75 \textcolor{preprocessor}{\#define N25Q512A\_FLASH\_SIZE                  0x4000000 }\textcolor{comment}{/* 512 MBits => 64MBytes */}\textcolor{preprocessor}{}}
\DoxyCodeLine{76 \textcolor{preprocessor}{\#define N25Q512A\_SECTOR\_SIZE                 0x10000   }\textcolor{comment}{/* 1024 sectors of 64KBytes */}\textcolor{preprocessor}{}}
\DoxyCodeLine{77 \textcolor{preprocessor}{\#define N25Q512A\_SUBSECTOR\_SIZE              0x1000    }\textcolor{comment}{/* 16384 subsectors of 4kBytes */}\textcolor{preprocessor}{}}
\DoxyCodeLine{78 \textcolor{preprocessor}{\#define N25Q512A\_PAGE\_SIZE                   0x100     }\textcolor{comment}{/* 262144 pages of 256 bytes */}\textcolor{preprocessor}{}}
\DoxyCodeLine{79 }
\DoxyCodeLine{80 \textcolor{preprocessor}{\#define N25Q512A\_DUMMY\_CYCLES\_READ           8}}
\DoxyCodeLine{81 \textcolor{preprocessor}{\#define N25Q512A\_DUMMY\_CYCLES\_READ\_QUAD      10}}
\DoxyCodeLine{82 \textcolor{preprocessor}{\#define N25Q512A\_DUMMY\_CYCLES\_READ\_DTR       6}}
\DoxyCodeLine{83 \textcolor{preprocessor}{\#define N25Q512A\_DUMMY\_CYCLES\_READ\_QUAD\_DTR  8}}
\DoxyCodeLine{84 }
\DoxyCodeLine{85 \textcolor{preprocessor}{\#define N25Q512A\_BULK\_ERASE\_MAX\_TIME         480000}}
\DoxyCodeLine{86 \textcolor{preprocessor}{\#define N25Q512A\_SECTOR\_ERASE\_MAX\_TIME       3000}}
\DoxyCodeLine{87 \textcolor{preprocessor}{\#define N25Q512A\_SUBSECTOR\_ERASE\_MAX\_TIME    800}}
\DoxyCodeLine{88 }
...
\DoxyCodeLine{191 \textcolor{preprocessor}{\#define N25Q512A\_SR\_WIP                      ((uint8\_t)0x01)    }}
\DoxyCodeLine{192 \textcolor{preprocessor}{\#define N25Q512A\_SR\_WREN                     ((uint8\_t)0x02)    }}
\DoxyCodeLine{193 \textcolor{preprocessor}{\#define N25Q512A\_SR\_BLOCKPR                  ((uint8\_t)0x5C)    }}
\DoxyCodeLine{194 \textcolor{preprocessor}{\#define N25Q512A\_SR\_PRBOTTOM                 ((uint8\_t)0x20)    }}
\DoxyCodeLine{195 \textcolor{preprocessor}{\#define N25Q512A\_SR\_SRWREN                   ((uint8\_t)0x80)    }}
\DoxyCodeLine{197 \textcolor{comment}{/* Non volatile Configuration Register */}}
\DoxyCodeLine{198 \textcolor{preprocessor}{\#define N25Q512A\_NVCR\_NBADDR                 ((uint16\_t)0x0001) }}
\DoxyCodeLine{199 \textcolor{preprocessor}{\#define N25Q512A\_NVCR\_SEGMENT                ((uint16\_t)0x0002) }}
\DoxyCodeLine{200 \textcolor{preprocessor}{\#define N25Q512A\_NVCR\_DUAL                   ((uint16\_t)0x0004) }}
\DoxyCodeLine{201 \textcolor{preprocessor}{\#define N25Q512A\_NVCR\_QUAB                   ((uint16\_t)0x0008) }}
\DoxyCodeLine{202 \textcolor{preprocessor}{\#define N25Q512A\_NVCR\_RH                     ((uint16\_t)0x0010) }}
\DoxyCodeLine{203 \textcolor{preprocessor}{\#define N25Q512A\_NVCR\_ODS                    ((uint16\_t)0x01C0) }}
\DoxyCodeLine{204 \textcolor{preprocessor}{\#define N25Q512A\_NVCR\_XIP                    ((uint16\_t)0x0E00) }}
\DoxyCodeLine{205 \textcolor{preprocessor}{\#define N25Q512A\_NVCR\_NB\_DUMMY               ((uint16\_t)0xF000) }}
\DoxyCodeLine{207 \textcolor{comment}{/* Volatile Configuration Register */}}
\DoxyCodeLine{208 \textcolor{preprocessor}{\#define N25Q512A\_VCR\_WRAP                    ((uint8\_t)0x03)    }}
\DoxyCodeLine{209 \textcolor{preprocessor}{\#define N25Q512A\_VCR\_XIP                     ((uint8\_t)0x08)    }}
\DoxyCodeLine{210 \textcolor{preprocessor}{\#define N25Q512A\_VCR\_NB\_DUMMY                ((uint8\_t)0xF0)    }}
\DoxyCodeLine{212 \textcolor{comment}{/* Extended Address Register */}}
\DoxyCodeLine{213 \textcolor{preprocessor}{\#define N25Q512A\_EAR\_A24                     ((uint8\_t)0x01)    }}
\DoxyCodeLine{215 \textcolor{comment}{/* Enhanced Volatile Configuration Register */}}
\DoxyCodeLine{216 \textcolor{preprocessor}{\#define N25Q512A\_EVCR\_ODS                    ((uint8\_t)0x07)    }}
\DoxyCodeLine{217 \textcolor{preprocessor}{\#define N25Q512A\_EVCR\_VPPA                   ((uint8\_t)0x08)    }}
\DoxyCodeLine{218 \textcolor{preprocessor}{\#define N25Q512A\_EVCR\_RH                     ((uint8\_t)0x10)    }}
\DoxyCodeLine{219 \textcolor{preprocessor}{\#define N25Q512A\_EVCR\_DUAL                   ((uint8\_t)0x40)    }}
\DoxyCodeLine{220 \textcolor{preprocessor}{\#define N25Q512A\_EVCR\_QUAD                   ((uint8\_t)0x80)    }}
\DoxyCodeLine{222 \textcolor{comment}{/* Flag Status Register */}}
\DoxyCodeLine{223 \textcolor{preprocessor}{\#define N25Q512A\_FSR\_NBADDR                  ((uint8\_t)0x01)    }}
\DoxyCodeLine{224 \textcolor{preprocessor}{\#define N25Q512A\_FSR\_PRERR                   ((uint8\_t)0x02)    }}
\DoxyCodeLine{225 \textcolor{preprocessor}{\#define N25Q512A\_FSR\_PGSUS                   ((uint8\_t)0x04)    }}
\DoxyCodeLine{226 \textcolor{preprocessor}{\#define N25Q512A\_FSR\_VPPERR                  ((uint8\_t)0x08)    }}
\DoxyCodeLine{227 \textcolor{preprocessor}{\#define N25Q512A\_FSR\_PGERR                   ((uint8\_t)0x10)    }}
\DoxyCodeLine{228 \textcolor{preprocessor}{\#define N25Q512A\_FSR\_ERERR                   ((uint8\_t)0x20)    }}
\DoxyCodeLine{229 \textcolor{preprocessor}{\#define N25Q512A\_FSR\_ERSUS                   ((uint8\_t)0x40)    }}
\DoxyCodeLine{230 \textcolor{preprocessor}{\#define N25Q512A\_FSR\_READY                   ((uint8\_t)0x80)    }}
\DoxyCodeLine{243 \textcolor{preprocessor}{\#ifdef \_\_cplusplus}}
\DoxyCodeLine{244 \}}
\DoxyCodeLine{245 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{246 }
\DoxyCodeLine{247 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* \_\_N25Q512A\_H */}\textcolor{preprocessor}{}}
\DoxyCodeLine{248 }
